...
public class flowerStudioMainApp{
    ...
    {        
        ...
        do {
            ...
            if(userInput == JOptionPane.YES_OPTION) 
            {
                ...
                if(choice== 1)
                {
                    ...
                    String membership = JOptionPane.showInputDialog("Enter Customer Membership Status: ");
        ...
        percentage = (vipCount / totalCount ) * 100;
        percentageN=(normalCount / totalCount ) * 100;
        System.out.println(totalCount);
        System.out.println("Percentage of normal customer: " + percentageN + "%");
